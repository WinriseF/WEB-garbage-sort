...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '环境问题上报表 (\"随手拍\")' ROW_FORMAT = Dynamic;
...
INSERT INTO `environmentalreports` VALUES (5, 8, 'pollution_incident', '水是黑色的，上面工厂乱排乱放', 'uploads/reports/31a61287-b0cb-447a-9c93-be223a4bbf68_176504ce4a6209cf5a1e674a12c46068.jpg', NULL, NULL, '成都XX大学XX渠', '2025-06-19 12:47:08', 'invalid', '确实，建议去西南XX大学', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '知识文章表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '旧物利用物品信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of recyclingitems
-- ----------------------------
INSERT INTO `recyclingitems` VALUES (4, 8, '成都理工大学石碑', '老古董', 'uploads/recycling/017bbb6d-dfff-41e7-9c5c-9325e2a02345_QQ图片20240428125807.jpg', '一台电脑', '2234434284', 'available', '2025-06-19 14:58:40');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '旧物回收/捐赠信息平台表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '地区信息表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `usergamescores` VALUES (2, 8, 1, 101, '2025-06-19 14:09:06', 1);
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (8, 'admin', '$2a$10$NBX.yScS84Wb22F6/i7z/.5nPnvu5s8BbwawTclzTWWzFAMPfBEoK', NULL, 'admin', 'teenager', NULL, 'admin', '2025-06-18 15:39:34', '2025-06-20 10:39:38', 1, 'uploads/avatars/user8_c56a9cfe.png');
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '教育视频信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of videos
-- ----------------------------
INSERT INTO `videos` VALUES (1, '黑马程序员软件测试视频教程，软件测试基础入门到项目实战', '传智教育·黑马程序员软件测试研究院全新录制的软件测试入门教程\r\n全部配套资源领取方式：关注黑马程序员公众号，回复关键词:领取资源02\r\n===============================\r\n课程内容：\r\n1、软件测试基础\r\n2、测试设计\r\n3、缺陷管理\r\n4、Web常用标签\r\n5、项目实战\r\n以终为始，由交付实战目标为终，推出所学知识；从认识软件及软件测试，到如何设计测试、缺陷标准及缺陷管理，最终以项目实战贯穿所学知识，让知识与应用相结合。\r\n===============================\r\n本教程学完请继续下一课程：Linux系统BV11t411M7uZ', '//player.bilibili.com/player.html?isOutside=true&aid=893108732&bvid=BV1TP4y1J7BD&cid=1597770412&p=1', '', NULL, 8, 0, 0, '2025-06-18 16:26:35', 'archived', NULL, NULL);
